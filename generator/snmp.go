...
func (gen *Trap) buildSnmpTrap() gosnmp.SnmpTrap {
	...
	if gen.config.IsSnmpV2c() {
		trap = gen.createSnmpV2Trap()
	} else {
		trap = gen.createSnmpV1Trap()
	}
...
func (gen *Trap) getSourceIP() string {
	source := gen.config.Host
...
func (gen *Trap) createSnmpV1Trap() gosnmp.SnmpTrap {
	return gosnmp.SnmpTrap{
		Enterprise:   gen.config.TrapID,
		AgentAddress: gen.getSourceIP(),
...
func (gen *Trap) createSnmpV2Trap() gosnmp.SnmpTrap {
	return gosnmp.SnmpTrap{
